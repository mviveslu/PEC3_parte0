...
/*Parámetro mal escrito o nulo */ idCompeticion;
...
function buildFiel(resultado) {
    ...
    const playerList = (0, _utilesJs.createanElement)("ul", "players-court");
    /*Build players*/ resultado.players.map((element, index)=>{
        const playerIl = (0, _utilesJs.createanElement)("li", "player-element-court");
...
//# sourceMappingURL=detalles.1a7843b2.js.map

...
/*Parámetro mal escrito o nulo */ idJugadora;
const resultado = (0, _dataIntestingPlayersJsonDefault.default).find((element)=>element.id === idJugadora);
/*No lo encuentra */ if (resultado.length == 0) console.log("array nulo");
else {
...
/*Article header */ function articleHeader(namePlayerComplete, positionPlayer, bornPlayer, nameFlag, instagramLink, facebookLink) {
    ...
    /*Social media */ const socialMediaHeader = createanElement("div", "social-media-player");
    ...
    logoInstagram.setAttribute("src", (0, _instagramPngDefault.default));
    ...
    logoFacebook.setAttribute("src", (0, _facebookPngDefault.default));
...
/*Seccion de biografía*/ function biography(array) {
    ...
    const titleSection = document.createElement("h2");
    titleSection.innerHTML = "Biograf\xeda";
